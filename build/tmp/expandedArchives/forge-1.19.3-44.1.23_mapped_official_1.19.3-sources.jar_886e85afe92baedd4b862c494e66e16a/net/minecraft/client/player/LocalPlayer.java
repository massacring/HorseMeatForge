...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   public PlayerRideableJumping jumpableVehicle() {
      ...
      if (entity instanceof PlayerRideableJumping playerrideablejumping) {
         if (playerrideablejumping.canJump(this)) {
   ...
   public void aiStep() {
      ...
      boolean flag4 = this.hasEnoughFoodToStartSprinting();
      if ((this.onGround || this.isUnderWater() || this.isPassenger() && this.getVehicle().isOnGround() || this.canStartSwimming()) && !flag1 && !flag2 && this.hasEnoughImpulseToStartSprinting() && !this.isSprinting() && flag4 && !this.isUsingItem() && !this.hasEffect(MobEffects.BLINDNESS)) {
